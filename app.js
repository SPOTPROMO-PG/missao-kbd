...
const CONTENT = {
  marcas: [
    ...
    { id: "pantene", nome: "PANTENE", logo: "logos/pantene.png", kbds: [
      ...
      { id: "kbd2", nome: "KBD Top Versões – Bambu, Colágeno e Biotinamina B3 (40%)", videoId: null, imagens: ["kbds/top vers#U00f5es pantene .jpg"] },
    ...
    { id: "venus", nome: "VENUS", logo: "logos/venus.png", kbds: [
      ...
      { id: "kbd3", nome: "KBD Checkout – Venus Pele Sensível", videoId: null, imagens: ["kbds/KBD VENUS  CHECKOUT (PELE SENS#U00cdVEL).jpg"] },
    ]},
  ],
};
...
const AVAILABLE_KBD_ASSETS = [
  "kbds/15 frentes secret.jpg",
  "kbds/2 bandejas secret.jpg",
  "kbds/2 pontos de contato oral-b.jpg",
  "kbds/Always.jpg",
  "kbds/bloco azul downy.jpg",
  "kbds/bloco colorido downy.jpg",
  "kbds/bond repair pantene.jpg",
  "kbds/branqueamento oral-b.jpg",
  "kbds/ganchos c8 gillette.jpg",
  "kbds/KBD GILLETTE  2 PONTOS DE CONTATO .jpg",
  "kbds/KBD GILLETTE  CARGA MACH3 C8 (2 GANCHOS).jpg",
  "kbds/KBD VENUS  2 PONTOS DE CONTATO .jpg",
  "kbds/KBD VENUS  CHECKOUT (PELE SENS#U00cdVEL).jpg",
  "kbds/KBD VENUS  SISTEMAS (20_ GANCHOS).jpg",
  "kbds/layout bipe oral-b.jpg",
  "kbds/oleo pantene.jpg",
  "kbds/pants + premium sul pampers.jpg",
  "kbds/pants sp pampers.jpg",
  "kbds/ponto extra - downy.jpg",
  "kbds/ponto extra pampers.jpg",
  "kbds/rio cachoeira dourada pantene.jpg",
  "kbds/top vers#U00f5es pantene .jpg",
  "kbds/vale night ponto extra pammpers .jpg",
  "kbds/vale night SOS pampers.jpg"
];
...
function resolveKbdAsset(path) {
  const raw = String(path || "").trim();
  if (!raw) return raw;
  if (AVAILABLE_KBD_ASSETS.includes(raw)) return raw;
  const wanted = normalizeAssetName(raw);
  const match = AVAILABLE_KBD_ASSETS.find((item) => normalizeAssetName(item) === wanted);
  return match || raw;
}
...
function entrar() {
  ...
  if (!ALLOWED_SECTORS.includes(normalized)) {
    alert("Setor inválido. Verifique a lista de setores permitidos.");
    return;
  }
...
function renderHome() {
  ensureSetor();
  applyTopbar({ eyebrow: "", title: "", subtitle: "", showBack: false });
...
function getFallbackBulletText() {
  ...
  return firstWithJustification ? firstWithJustification.justificativa : "Revise o material da marca antes de seguir para garantir a execução correta do KBD.";
}
...
function mostrarResultadoFinal() {
  ...
  const finalBullet = pct < 100 ? getFallbackBulletText() : "";
